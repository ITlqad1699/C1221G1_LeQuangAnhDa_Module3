...
INSERT INTO furama_resort.vi_tri (`ma_vi_tri`, `ten_vi_tri`) 
VALUES 	('1', 'Quản Lý'),
		('2', 'Nhân Viên');
        
INSERT INTO `furama_resort`.`trinh_do` (`ma_trinh_do`, `ten_trinh_do`) 
VALUES 	('1', 'Trung Cấp'),
		('2', 'Cao Đẳng '),
		('3', 'Đại Học'),
		('4', 'Sau Đại Học');
        
INSERT INTO `furama_resort`.`bo_phan` (`ma_bo_phan`, `ten_bo_phan`) 
VALUES	('1', 'Sale-Marketing'),
		('2', 'Hành Chính'),
		('3', 'Phục Vụ'),
		('4', 'Quản Lý');

INSERT INTO `furama_resort`.`loai_khach` (`ma_loai_khach`, `ten_loai_khach`) 
VALUES 	('1', 'Diamond'),
		('2', 'Platinium'),
		('3', 'Gold'),
		('4', 'Silver'),
...
INSERT INTO `furama_resort`.`kieu_thue` (`ma_kieu_thue`, `ten_kieu_thue`) 
VALUES 	('1', 'year'),
		('2', 'month'),
		('3', 'day'),
		('4', 'hour');

INSERT INTO `furama_resort`.`loai_dich_vu` (`ma_loai_dich_vu`, `ten_loai_dich_vu`)
VALUES 	('1', 'Villa'),
		('2', 'House'),
		('3', 'Room');

INSERT INTO `furama_resort`.`nhan_vien` (`ma_nhan_vien`, `ho_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `so_dien_thoai`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) 
values	(1, "Nguyễn Văn An", "1970-11-07","456231786", 10000000, "0123456789", "annguyen@gmail.com", "295 Nguyễn Tất Thành, Đà Nẵng", 1, 3, 1),
...
values 	("Nguyễn Thị Hào","1970-11-07",b'0',"643431213","0945423362","thihao07@gmail.com","23 Nguyễn Hoàng,Hải Châu,Đà Nẵng",5),
		...
		("Dương Văn Quan","1981-07-08",b'1',"543432111","0490039241","duongquan@gmail.com","K453/12 Lê Lợi,Hải Châu, Đà Nẵng",1),
		("Hoàng Trần Nhi Nhi","1995-12-09",b'0',"795453345","0312345678","nhinhi123@gmail.com","224 Lý Thái Tổ, Gia Lai",4),
		("Tôn Nữ Mộc Châu","2005-12-06",b'0',"732434215","0988888844","tonnuchau@gmail.com","37 Yên Thế,Liên Chiểu, Đà Nẵng",4),
		...
		("Nguyễn Tâm Đắc","1989-07-01",b'1',"344343432","0987654321","tdactam@gmail.com","22 Ngô Quyền, Ngũ Hành Sơn,Đà Nẵng",2);
...
values 	("2020-12-08","2020-12-08",0,3,1,3),
 ...
 INSERT INTO `furama_resort`.`dich_vu_di_kem` (`ma_dich_vu_di_kem`, `ten_dich_vu_di_kem`, `gia`, `don_vi`, `trang_thai`) 
