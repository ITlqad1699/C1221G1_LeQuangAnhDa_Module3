...
INSERT INTO `furama_resort`.`hop_dong` (`ma_hop_dong`, `ngay_lam_hop_dong`, `ngay_ket_thuc`, `tien_dat_coc`, `ma_nhan_vien`, `ma_khach_hang`, `ma_dich_vu`) 
values 	(1,"2020-12-08","2020-12-08",0,3,1,3),
		(2,"2020-07-21","2020-07-21",200000,7,3,1),
