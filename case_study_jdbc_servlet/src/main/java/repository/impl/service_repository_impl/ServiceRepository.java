...
public class ServiceRepository implements IServiceRepository {
    ...
    private static final String INSERT_SERVICE_SQL = "INSERT INTO dich_vu" + "  ( ten_dich_vu, dien_tich,chi_phi_thue,so_nguoi_toi_da,tieu_chuan_phong,mo_ta_tien_nghi_khac,dien_tich_ho_boi,so_tang,ma_kieu_thue,ma_loai_dich_vu) VALUES " +
            " (?, ?, ?,?,?,?,?,?,?,?);";
    ...
    public void save(Service service) {
        ...
        try {
            ...
            preparedStatement.setString(6, service.getOther());
            preparedStatement.setDouble(7,service.getSwimmingPoolArea());
            preparedStatement.setInt(8,service.getFloorNum());
            preparedStatement.setInt(9,service.getRentalTypeId());
