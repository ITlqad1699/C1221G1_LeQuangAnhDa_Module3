...
<form method="post">
    <table class="table">
        <tr>
            <td>Name</td>
            <td><input type="text" placeholder="Edit name" name="name" id="name"
                       value="${requestScope["products"].name}"></td>
        </tr>
        <tr>
            <td>Price</td>
            <td><input type="text" placeholder="Edit price" name="price" id="price"
        ...
        <tr>
            <td>Producer</td>
            <td><input type="text" placeholder="Edit producer" name="producer" id="producer"
